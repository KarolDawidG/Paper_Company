...
export const Sidebars = ({ children }: { children: React.ReactNode }) => {
  ...
  const menuItems = [
    ...
    {
      name: `${t.side_bar.sales_and_orders}`,
      path: "/sales-and-orders",
      icon: <FaShoppingCart />,
      color: "green",
    },
    {
      name: `${t.side_bar.warehouse}`,
      path: "/warehouse",
      icon: <FaWarehouse />,
      color: "orange",
    },
    {
      name: `${t.side_bar.accounting}`,
      path: "/accounting",
    ...
    {
      name: `${t.side_bar.data_analysis}`,
      path: "/data-analysis",
      icon: <FaChartLine />,
      color: "pink",
    },
    {
      name: `${t.side_bar.security}`,
      path: "/security",
      icon: <FaShieldAlt />,
      color: "gray",
    },
  ...
  return (
    <Box display="flex">
      ...
      <Box
        component="main"
        sx={{ flexGrow: 1, p: 3, marginLeft: { md: `${drawerWidth}px` } }}
      >
        {children}
      </Box>
    </Box>
